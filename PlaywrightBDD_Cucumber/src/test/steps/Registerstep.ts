...
When('the user enter lastname as {string}', async function (this:CustomWorld,string) {

    await this.page.locator("#input-lastname").fill(string);
  
});

When('the user enter email as {string}', async function (this:CustomWorld,string) {
...
When('the user enter telephone as {string}', async function (this:CustomWorld,string) {

    await this.page.locator("#input-telephone").fill(string);
 
});

When('the user enter password as {string}', async function (this:CustomWorld,string) {
...
When('the user enter confirm password as {string}', async function (this:CustomWorld,string) {
